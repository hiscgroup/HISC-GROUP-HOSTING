local DISCORD_WEBHOOK = "https://discord.com/api/webhooks/794870736556392488/Es4WQHMGkSfJ-EMZYiK62AYJt2SCcePJzreAg-K8eMGIMK2h_rtgRe0goZVaNz-LEpyK"
...
AddEventHandler('log', function(data)
    ...
    PerformHttpRequest(DISCORD_WEBHOOK, function(err, text, headers) end, 'POST', json.encode({username = "Police Forms",  avatar_url = "https://www.pinclipart.com/picdir/big/114-1149058_hellenic-police-logo-clipart.png",embeds = connect}), { ['Content-Type'] = 'application/json' })
end)
