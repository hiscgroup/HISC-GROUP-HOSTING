...
AddEventHandler('eden_accesories:silencieux', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used < silencieux then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("You have just equipped yourself with a silencer.")) 
		  		 	used = used + 1
	...
	used = used + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in your hands or your weapon can not support a silencer."))
		  		
			end
			else
					  		 ESX.ShowNotification(("You used all your silencers.")) 
...
AddEventHandler('eden_accesories:flashlight', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used2 < flashlight then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("You have just equipped yourself with a flashlight.")) 
		  		 	used2 = used2 + 1
		  	elseif currentWeaponHash == GetHashKey("WEAPON_PISTOL50") then
	...
	used2 = used2 + 1
		  		  ...
		  		  ESX.ShowNotification(("You have no weapon in your hands or your weapon can not support a flashlight."))
		  		
			end
		else
				  		  ESX.ShowNotification(("You used all your flashlights."))
...
AddEventHandler('eden_accesories:grip', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used3 < grip then
			...
			if currentWeaponHash == GetHashKey("WEAPON_COMBATPDW") then
		  		 ...
		  		 ESX.ShowNotification(("You have just equipped yourself with a grip.")) 
		  				used3 = used3 + 1
	...
	used3 = used3 + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in hand or your weapon does not support grips"))
		  		
			end
		else
				  		  ESX.ShowNotification(("You used all your grips."))
		end
end)
...
AddEventHandler('eden_accesories:yusuf', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used4 < yusuf then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("You have just equipped your skin weapon.")) 
		  		 	used4 = used4 + 1
	...
	used4 = used4 + 1
		  		  ...
		  		  ESX.ShowNotification(("You have no weapon in hand or your weapon cannot stand a luxury look."))
		  		
			end
		else
				  		  ESX.ShowNotification(("You used all the luxury skins."))
